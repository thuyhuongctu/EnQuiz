...
(function (global) {
  ...
  var DICT = {
    vi: {
      ...
      'chapters.eyebrow': 'Nội dung học phần',
      ...
      'advisor.role': 'Trường Kinh tế, Đại học Cần Thơ',
      ...
      'advisor.badge': 'Case study chuyên sâu',
      'advisor.intro': 'Case study chiến lược do <strong>PGS.TS. Phan Anh Tú</strong> trực tiếp biên soạn dành riêng cho học phần KT330H nâng cao.',
      'advisor.standard': 'Chuẩn chương trình KT330H chất lượng cao',
      ...
      'unlock.hint': 'Cần nhập email trường một lần để mở khoá.',
      'unlock.title': 'Mở khoá tài liệu case study',
      'unlock.desc': 'Nhập email trường để Thầy Tú/Cô Hương biết ai đã xem tài liệu case study gốc — chỉ cần nhập một lần trên máy này.',
      'unlock.label': 'Email trường',
      'unlock.placeholder': 'ten@truong.edu.vn',
      'unlock.submit': 'Mở khoá',
      'unlock.invalid': 'Email không hợp lệ, thử lại.',
      'unlock.failed': 'Không mở khoá được, thử lại.',
      'unlock.networkErr': 'Lỗi mạng, thử lại.',
      'caseInfo.title': 'Tóm tắt case study',
      'caseInfo.viewLabel': 'Xem tóm tắt case',
      ...
      'result.eyebrow': 'Phân tích bài làm',
      'result.byChapter': 'Thống kê theo chương',

      'insight.title': 'Hương AI gợi ý',
      'insight.weak': 'Chương yếu nhất của bài này là {chapter} — bạn đúng {correct}/{total} câu, tức {pct}%. Ôn lại đúng chương đó sẽ kéo điểm lên nhanh nhất.',
      'insight.allGood': 'Bài này bạn đều trên 90% ở mọi chương. Giữ nhịp mỗi ngày một đề ngắn là đủ để nhớ lâu.',
      'insight.cta': 'Luyện chương này',

      'clock.eyebrow': 'Hai múi giờ',
      'clock.heading': 'Bây giờ là',
      'clock.vn': 'Việt Nam',
      'clock.fr': 'Pháp',
      ...
      'badge.locked': 'Chưa mở · {now}/{need}',
      'badge.first': 'Khởi hành',
      'badge.first.done': 'Đã làm xong đề đầu tiên',
      'badge.streak': 'Chuỗi 7 ngày',
      'badge.streak.done': 'Học liên tục 7 ngày',
      'badge.perfect': 'Điểm tuyệt đối',
      'badge.perfect.done': 'Từng đạt 10 điểm',
      'badge.expert': 'Chuyên gia',
      'badge.expert.done': 'Đã làm 50 đề',
      ...
      'tour.done.lead': 'Bạn đã sẵn sàng chưa? Cùng chinh phục môn Khởi sự doanh nghiệp nhé!',
      'tour.done.title': 'EnQuiz giúp bạn',
      'tour.done.b1': 'Đề ngẫu nhiên có bấm giờ, chấm điểm trên thang 10.',
      'tour.done.b2': 'Ghi nhớ câu sai và tiến độ theo từng chương.',
      'tour.done.b3': 'Hương AI dẫn đường bằng giọng nói, hai thứ tiếng.',
      'tour.done.go': '🚀 Bắt đầu làm bài',
    ...
    en: {
      ...
      'chapters.eyebrow': 'Course content',
      ...
      'advisor.role': 'School of Economics, Can Tho University',
      ...
      'advisor.stop': 'Stop',
      'advisor.badge': 'Specialized university cases',
      'advisor.intro': 'Strategic case studies written directly by <strong>Assoc. Prof. Dr. Phan Anh Tu</strong> for the advanced KT330H track.',
      'advisor.standard': 'KT330H high-quality business program standard',
      ...
      'unlock.hint': 'Enter your school email once to unlock.',
      'unlock.title': 'Unlock case study materials',
      'unlock.desc': 'Enter your school email so Assoc. Prof. Tu / Ms. Huong know who viewed the original case study materials — only needed once on this device.',
      'unlock.label': 'School email',
      'unlock.placeholder': 'you@school.edu',
      'unlock.submit': 'Unlock',
      'unlock.invalid': 'That email doesn’t look right — try again.',
      'unlock.failed': 'Could not unlock — try again.',
      'unlock.networkErr': 'Network error — try again.',
      'caseInfo.title': 'Case study summary',
      'caseInfo.viewLabel': 'View case summary',
      ...
      'result.skip': 'Skipped',
      'result.time': 'Time',
      'result.eyebrow': 'Paper analysis',
      'result.byChapter': 'Breakdown by chapter',

      'insight.title': 'Huong AI suggests',
      'insight.weak': 'Your weakest chapter in this paper is {chapter} — you got {correct}/{total} right, which is {pct}%. Revising that one chapter will lift your score fastest.',
      'insight.allGood': 'You scored above 90% in every chapter of this paper. Keep to one short paper a day and it will stay with you.',
      'insight.cta': 'Practise this chapter',

      'clock.eyebrow': 'Two time zones',
      'clock.heading': 'Right now',
      'clock.vn': 'Vietnam',
      'clock.fr': 'France',
      ...
      'badge.locked': 'Locked · {now}/{need}',
      'badge.first': 'First launch',
      'badge.first.done': 'Finished your first paper',
      'badge.streak': 'Seven-day run',
      'badge.streak.done': 'Seven days in a row',
      'badge.perfect': 'Perfect score',
      'badge.perfect.done': 'Scored a full 10',
      'badge.expert': 'Seasoned',
      'badge.expert.done': 'Fifty papers done',
      ...
      'tour.done.lead': 'Ready? Let us go and conquer the Entrepreneurship course!',
      'tour.done.title': 'What EnQuiz gives you',
      'tour.done.b1': 'A random, timed paper scored out of 10.',
      'tour.done.b2': 'Your missed questions and chapter progress, remembered.',
      'tour.done.b3': 'Huong AI guiding you by voice, in two languages.',
      'tour.done.go': '🚀 Start a paper',
