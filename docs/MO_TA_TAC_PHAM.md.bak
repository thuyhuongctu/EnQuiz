...
| Tác giả thứ nhất | Đỗ Thùy Hương. Giảng viên Trường Đại học Sư phạm Kỹ thuật Vĩnh Long (VLUTE), nghiên cứu sinh Đại học Cần Thơ. ORCID 0000-0002-7711-2487 |
| Tác giả thứ hai | Phan Anh Tú. Phó giáo sư, tiến sĩ, Phó Hiệu trưởng Trường Kinh tế, Đại học Cần Thơ, Khoa Kinh doanh quốc tế. ORCID 0000-0003-0667-3137 |
...
cài được lên màn hình chính như một ứng dụng thường, và dùng được khi không có
mạng.

## 2. Những điểm riêng của tác phẩm

Chạy hoàn toàn phía người dùng, không có máy chủ. Toàn bộ ngân hàng câu hỏi,
phần chấm điểm, thống kê và lịch sử học tập nằm trong trình duyệt. Không có
máy chủ nào lưu dữ liệu người học. Điều này vừa là giải pháp kỹ thuật cho vùng
mạng yếu, vừa là cách bảo vệ dữ liệu cá nhân của sinh viên ngay từ thiết kế.

Bộ ghép đề với đáp án. Giảng viên dán đề vào một ô, dán bảng đáp án vào ô còn
lại; chương trình tự nhận dạng nhiều kiểu đánh số khác nhau (`Câu 1.`,
`Question 1:`, `1)`, `1 - B`, `1B`…) rồi ghép theo số thứ tự in trên đề chứ
không theo thứ tự dán vào, nên dán một phần đề vẫn ghép đúng. Đây là phần được
viết riêng cho tác phẩm này, xem `assets/js/parser.js`.

Song ngữ Việt, Anh trọn vẹn. Mọi chuỗi hiển thị nằm trong một từ điển duy
nhất, đổi ngôn ngữ ngay lập tức không tải lại trang.

Phần hướng dẫn có thuyết minh bằng giọng thật. Mười bước hướng dẫn, mỗi bước
làm nổi đúng vùng màn hình đang nói tới, kèm bản thu giọng của chính tác giả
ở cả hai thứ tiếng, mở đầu bằng một câu chào tiếng Pháp.

Gợi ý sau khi nộp bài. Chương trình đối chiếu kết quả theo từng chương, chỉ
ra chương đang mất điểm nhiều nhất và mở thẳng phần luyện tập của chương ấy.

Bản sắc riêng. Hình nhân vật, logo, bản đồ đồng bằng sông Cửu Long làm nền
chìm, quả địa cầu dựng bằng phép chiếu trực giao, và một ca khúc do chính tác
giả sáng tác.
...
300 câu trắc nghiệm bốn phương án, chia đều 5 chương, do tác giả biên soạn
theo nội dung học phần mình giảng dạy. Danh sách đầy đủ kèm đáp án đúng nằm ở
tài liệu *Ngân hàng câu hỏi* nộp kèm.
...
| 2 | Phan Anh Tú | Phó giáo sư, tiến sĩ, Phó Hiệu trưởng Trường Kinh tế, Đại học Cần Thơ (Khoa Kinh doanh quốc tế) | Đồng tác giả | Định hướng phương pháp khoa học, thiết kế mô hình logic, góp ý nội dung |

Bảng phân chia đóng góp ở trên cần hai đồng tác giả xác nhận trước khi nộp,
vì cơ quan đăng ký căn cứ vào đó để ghi tên trên giấy chứng nhận.
...
Tác phẩm được tạo ra bằng thời gian, thiết bị và chi phí cá nhân, ngoài giờ
làm việc. Điều này đối chiếu được với dấu thời gian các commit trong
`DONG_THOI_GIAN.md`.

Chủ sở hữu quyền tài sản đã chốt. Tác giả thứ hai là viên chức Đại học Cần
Thơ, nên việc đưa tên đồng tác giả là viên chức của một cơ sở giáo dục đại học
có thể làm phát sinh quyền của cơ sở ấy theo quy chế sở hữu trí tuệ nội bộ,
như dự án M-AIDA của cùng nhóm tác giả, nơi Đại học Cần Thơ được ghi là đồng
chủ sở hữu. Hai đồng tác giả đã thống nhất: chỉ hai cá nhân đồng sở hữu, chia
đều 50/50, không có Đại học Cần Thơ tham gia. Vẫn nên xin một văn bản ngắn
của Đại học Cần Thơ xác nhận không giao nhiệm vụ, để củng cố hồ sơ (mẫu ở
