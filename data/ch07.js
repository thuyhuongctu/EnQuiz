...
{
  "id": "ch07",
  "title": "Case study: Betterteem (Cross-Border Expansion) · KT330H",
  "titleEn": "Case Study: Betterteem (Cross-Border Expansion) · KT330H",
  "order": 7,
  "group": "kt330h",
  "questions": [
    {
      "q": "What distinguishes Betterteem AI® from traditional HR survey tools described in the case?",
      "a": [
        "Its exclusive focus on payroll and compensation data",
        "Its ability to predict resignation risk using sentiment and behavioral data",
    ...
    },
    {
      ...
      "a": [
        "HR managers lacked the authority to approve any software purchases",
        "Executive leaders were more affected by the turnover's financial impact",
    ...
    },
    {
      ...
      "a": [
        "Iterative feedback from HR professionals using a free prototype",
        "Benchmarking against global HR-tech competitors",
    ...
    },
    {
      ...
      "a": [
        "Saturation of the Philippine HR-tech market",
        "Pressure from investors to scale regionally",
    ...
    },
    {
      ...
      "a": [
        "Southeast Asia emphasizes enterprise-grade AI more than Northeast Asia",
        "Northeast Asia has lower regulatory complexity for SaaS startups",
    ...
    },
    {
      ...
      "a": [
        "By asking clients to co-finance international rollouts",
        "By delaying entry until large venture funding was secured",
    ...
    },
    {
      ...
      "a": [
        "It provided guaranteed enterprise customers",
        "It replaced the need for local market research",
    ...
    },
    {
      ...
      "a": [
        "Higher valuation during fundraising rounds",
        "Reduced dependence on product revenue",
    ...
    },
    {
      ...
      "a": [
        "Expectation of in-person engagement with senior executives",
        "Preference for fully digital sales processes",
